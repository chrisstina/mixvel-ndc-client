...
exports.ServiceDeleteMessageMapper = void 0;
...
var ServiceDeleteMessageMapper = /** @class */ (function () {
    function ServiceDeleteMessageMapper(params, credentials) {
        this.params = params;
        this.credentials = credentials;
    }
    ServiceDeleteMessageMapper.prototype.map = function () {
        var _this = this;
    ...
    ServiceDeleteMessageMapper.prototype.passengerToPax = function (passenger) {
        var individual = {
    ...
    return ServiceDeleteMessageMapper;
}());
exports.ServiceDeleteMessageMapper = ServiceDeleteMessageMapper;
