...
export function isPriceProps(props: RequestProps<unknown>): props is PriceProps {
    return (props as PriceProps).offers !== undefined
}

export function isOrderRetrieveProps(props: RequestProps<unknown>): props is OrderRetrieveProps {
